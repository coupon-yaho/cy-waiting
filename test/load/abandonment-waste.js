...
//
// **실행 전체로 재면 안 된다.** 시작 직후에는 아무도 아직 안 걷혔으므로, 처음
// 생존 수명(250초) 동안 차례가 온 이탈자는 전부 낭비다. 그 구간을 포함해 재면
// 낭비율이 `이탈률 × 수명 / 실행_길이` 로 나오고, 이것은 기구의 성능이 아니라
// 실행을 얼마나 길게 잡았는지를 재는 값이다. 정상 구간에서 잰다.
