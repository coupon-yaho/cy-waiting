...
public final class GatewayRedisPort {
    ...
    /**
     * 하트비트를 남기고 <b>이 노드가 본 서킷을 같이 싣는다</b>. 안 실으면 배분이
     * 리더 한 대의 관측으로 전 클러스터의 크레딧을 정한다.
     *
     ...
     * 드나들어 분모와 표가 다른 회차의 것이 된다. reported 가 alive 보다 작으면
     * 롤아웃 중이라는 뜻이라 게이지로 낼 재료다. 판정의 분모로 쓰면 안 된다 —
     * 근거는 ClusterCircuit.of 의 주석에 있다.
     *
