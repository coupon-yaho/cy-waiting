...
| ID | 날짜 | 종류 | 제목 | 확신 | 승격 |
|---|---|---|---|---|---|
| [AIJ-0029](2026/08/AIJ-0029-dependency-scan.md) | 2026-08-20 | decision | 초록불이 근거 없는 초록불이었다 | high | — |
| [AIJ-0027](2026/08/AIJ-0027-chaos-fixtures.md) | 2026-08-20 | implement | 장애 주입 픽스처 — 게이트는 선언한 페이즈에서 판정할 수 있어야 한다 | medium | — |
