...
check "부하 중 표본이 없으면 판정 불가" 2 "부하 중 표본이 없다" '0 5
1000 0'
check "부하 뒤 표본이 없으면 판정 불가" 2 "부하 뒤 표본이 없다" '-1000 90
-500 95'
check "칸 수가 다르면 판정 불가" 2 "두 칸" '-1000 90 7
0 0'
check "숫자가 아니면 판정 불가" 2 "숫자가 아닌" '-1000 아흔
0 0'
