 ...
 * 걸지 않는다</b> — 그러면 그 구간이 끝나는 순간이 새 계단이 되어, 실측에서 몫이
 * 33 에서 300 으로 뛰었다.
 */
public final class ReleaseRamp {
     ...
     * 회복에 걸리는 시간이다</b> — 다 오르는 데 {@code log(상한/하한)} 틱이 든다.
     * 배수 2.0 은 상한 1200 에서 회복이 34.9초였고 4.0 에서 22.7초다. 그 두 회차는
     * 조건이 서로 달라, 상한 300 인 기본 조건에서 되풀이해 확인한 값이 아니다.
     */
